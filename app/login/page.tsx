...
export default async function LoginPage({
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-warm-50 p-6">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-cream-200 bg-white p-10 shadow-warm-lg">
        ...
        <h1 className="text-2xl font-extrabold text-brown-900">סידור משמרות</h1>
